...
public:
    ...
    //pop sstatus.spp and sstatus.spie bits (has to be noninline function!)
    static void popSppSpie();


    static void pushRegistersV();

   static void popRegistersV();
...
inline void Riscv::pushRegistersV(){
    pushRegisters();
}

inline void Riscv::popRegistersV(){
    popRegisters();
}
